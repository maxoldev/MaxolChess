...
struct MovesAppliedTest {
    ...
    @Test func castlingRightsAfterKingMove() async throws {
        ...
        #expect(posAfterBlackKingMove.castlingRights[.black]!.isEmpty)
        ...
        #expect(posAfterBothKingsMove.castlingRights[.black]!.isEmpty)
        #expect(posAfterBothKingsMove.castlingRights[.white]!.isEmpty)
